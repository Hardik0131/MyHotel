    ...
    <div class="rooms_form">
        ...
        <form action="{{ route('admin.rooms.store', [], false) }}" method="POST" id="form" enctype="multipart/form-data">
            ...
            <div class="input-group">
                ...
                <input type="text" class="formControl" id="room_name" placeholder="Enter Rooms Name"
                    name="room_name" autocomplete="off" required>
            </div>
            <div class="input-group">
                ...
                <input type="number" class="formControl" id="price_per_night" name="price_per_night"
                    placeholder="Enter Price Per Night" autocomplete="off" min="1" step="0.01">
            </div>
            <div class="input-group">
                <label for="max_guests">Maximum Guests</label>
                <input type="number" class="formControl" id="max_guests" name="max_guests"
                    placeholder="Maximum Guests Allowed" autocomplete="off" min="1">
            </div>
            <div class="input-group">
            ...
            <div class="btn">
                <button type="submit" class="add_rooms">Add rooms</button>
